...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FormConnector = __webpack_require__(3);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AltFormActions = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"lib/AltFormActions\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	
	var _AltFormActions2 = _interopRequireDefault(_AltFormActions);
	...
	var StoreFactory = function StoreFactory(namespace, dispatcher, initialState) {
	  var _FormActions = (0, _AltFormActions2.default)(namespace),
	      changed = _FormActions.changed,
	      saved = _FormActions.saved,
	      canceled = _FormActions.canceled,
	      validationStarted = _FormActions.validationStarted,
