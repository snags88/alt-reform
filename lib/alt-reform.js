(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("alt-reform", [], factory);
	else if(typeof exports === 'object')
		exports["alt-reform"] = factory();
	else
		root["alt-reform"] = factory();
})(this, function() {
	  ...
	  return function (Component) {
	    return _react2.default.createClass({
	      ...
	      componentDidMount: function componentDidMount() {
	        ...
	        this.unlisten = form.store.listen(function (state) {
	      ...
	      render: function render() {
	        var fields = form.fields,
	            _form = _objectWithoutProperties(form, ['fields']);
	
	        return _react2.default.createElement(Component, _extends({}, _form, {
	          fields: fields(),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StoreFactory = function StoreFactory(namespace, dispatcher, initialState) {
	  ...
	  return dispatcher.createUnsavedStore({
	    ...
	    setNewTouchedState: function setNewTouchedState(newState, key) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createActions = __webpack_require__(36);
...
;
//# sourceMappingURL=alt-reform.js.map